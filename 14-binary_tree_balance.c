...
/**
 * binary_tree_balance - This code shall measure the balance factor of tree
 * @tree: This shall represent the root node of the tree to measure the balance
 * Return: This shall return the balance factor of the tree
 */
